...
from orchestration.support import task_files as task_files_module
from orchestration.support import paths as paths_module
...
class TestEnsureQueueDirs:
    ...
    def test_ensure_queue_dirs_creates_expected_structure(self, tmp_path, monkeypatch):
        ...
        fake_module_dir = tmp_path / "orchestration" / "support"
        fake_module_dir.mkdir(parents=True, exist_ok=True)
        fake_module_file = fake_module_dir / "paths.py"
        fake_module_file.write_text("# test", encoding="utf-8")

        monkeypatch.setattr(paths_module, "__file__", str(fake_module_file))
...
class TestAttemptPathHelpers:
    ...
    def test_get_queue_root(self, monkeypatch, tmp_path):
        ...
        queue_root = paths_module.get_queue_root()
    ...
    def test_get_attempt_dir_first_attempt(self, monkeypatch, tmp_path):
        ...
        attempt_dir = paths_module.get_attempt_dir("T-001", 0)
    ...
    def test_get_attempt_dir_second_attempt(self, monkeypatch, tmp_path):
        ...
        attempt_dir = paths_module.get_attempt_dir("T-001", 1)
    ...
    def test_get_attempt_config_dir(self, monkeypatch, tmp_path):
        ...
        config_dir = paths_module.get_attempt_config_dir("T-001", 0)
    ...
    def test_get_attempt_data_dir(self, monkeypatch, tmp_path):
        ...
        data_dir = paths_module.get_attempt_data_dir("T-001", 0)
    ...
    def test_attempt_paths_deterministic(self, monkeypatch, tmp_path):
        ...
        dir1 = paths_module.get_attempt_dir("T-001", 0)
        dir2 = paths_module.get_attempt_dir("T-001", 0)
        config1 = paths_module.get_attempt_config_dir("T-001", 0)
        config2 = paths_module.get_attempt_config_dir("T-001", 0)
    ...
    def test_attempt_paths_different_ids(self, monkeypatch, tmp_path):
        ...
        dir_001 = paths_module.get_attempt_dir("T-001", 0)
        dir_002 = paths_module.get_attempt_dir("T-002", 0)
    ...
    def test_attempt_paths_different_attempts(self, monkeypatch, tmp_path):
        ...
        dir_attempt_0 = paths_module.get_attempt_dir("T-001", 0)
        dir_attempt_1 = paths_module.get_attempt_dir("T-001", 1)
        dir_attempt_2 = paths_module.get_attempt_dir("T-001", 2)
